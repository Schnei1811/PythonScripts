...
# train_data = np.load('../data/Binary_{}_pixel_train_multitask_data.npy'.format(IMG_SIZE))
train_data = np.load('../data/Binary_{}_pixel_train_multitask_data800000.npy'.format(IMG_SIZE))
print('Loading Val Data...')
val_data = np.load('../data/Binary_{}_pixel_val_multitask_data.npy'.format(IMG_SIZE))
#val_data = np.load('../data/Binary_{}_pixel_val_multitask_data.npy'.format(IMG_SIZE))
