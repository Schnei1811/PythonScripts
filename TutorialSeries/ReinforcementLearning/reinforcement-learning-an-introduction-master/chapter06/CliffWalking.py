...
def figure6_5():
    ...
    for run in range(0, runs):
        ...
        for i in range(0, nEpisodes):
            # cut off the value by -1xdif-100 to draw the figure more elegantly
...
# with 1xdif-100,000 episodes and 1xdif-50,000 runs to get the fully averaged performance
