...
if __name__=='__main__':
    ...
    # Network = 'NASNetLarge'                        #0.825          #343MB                     #IMG_SIZE = 331
    # Network = 'Inception_Resnet_V2'                #0.803          #215MB
    # Network = 'Xception'                           #0.790          #88MB      #160
    # Network = 'ResNeXt101'                         #0.787          #170MB
    # Network = 'ResNet152V2'                        #0.780          #232MB
    # Network = 'InceptionV3'                        #0.779          #92MB      #160
    # Network = 'DenseNet201'                        #0.773          #80MB      #160
    # Network = 'NASNetMobile'                       #0.744          #23MB                      #IMG_SIZE = 224
    # Network = 'MobileNetV2'                        #0.713          #14MB      #160
    # Network = 'VGG16'                              #0.713          #528MB
    # Network = 'VGG19'                              #0.713          #549MB


    parser = argparse.ArgumentParser(description='Directories and Models')
    parser.add_argument('--train_dir', type=str, default='SpeciesID/Train/')
    parser.add_argument('--test_dir', type=str, default='SpeciesID/Test/')
