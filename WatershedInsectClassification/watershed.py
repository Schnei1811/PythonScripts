...
def watershed(i, img_path, threshold):
...
if __name__ == '__main__':
    ...
    black_white_img_dir = f"Black_White_div_{args.div}\\"
    boxes_img_dir = f"Boxes_div_{args.div}\\"
    contours_img_dir = f"Contours_div_{args.div}\\"
    extracted_images_dir = f"Extracted_{args.div}\\"
    grayscale_img_dir = f"Greyscale_div_{args.div}\\"
    mask_img_dir = f"Mask_div_{args.div}\\"

    cropped_img_dir = f"images\\"
